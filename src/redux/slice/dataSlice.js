   ...
   training:[
      {
         ...
         status:'Finalizado',
         hours: '300',
         description:['Estructuras de datos y algoritmos','Git - GitHub','HTML','CSS | Bootstrap','JavaScript','React','Redux Toolkit','Autenticación (con Firebase)','Conexión a Backend (con Firebase)','Metodologías Ágiles | Scrum'],
      },{
         id:2,
         ...
         status:'Finalizado',
         hours: '500',
         description:['Lógica de programación','HTML5','CSS3','JavaScript','Git&GitHub','Administración de MySQL: Seguridad y optimización de la base de datos','Python','Data Science en OCI','Oracle Analytics','Pitch para entrevistas','Hábitos','Foco','Gestión ágil','Emprendimiento','Fundamentos de agilidad','Hábitos de liderazgo','La empresa ágil','Business Model Canvas','Lean Startup','Organización de equipos ágiles','Productividad','Ciclo de vida del producto','LinkedIn','Emprendimiento'],
      },{
         id:3,
         ...
         status:'En pausa',
         hours: '700',
         description:['Estructuras de datos y algoritmos','Git - GitHub','HTML','CSS | SASS | Less | Bootstrap','JavaScript','React','Redux','Node','Express','PostgreSQL','Sequelize','Metodologías Ágiles | Scrum'],
      },{
         id:4,
